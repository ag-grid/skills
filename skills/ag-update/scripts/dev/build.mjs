...
//
// Usage: node build.mjs [outfile]   (outfile defaults to the shipped ../analyse-update.js;
// the compiled-js-up-to-date test builds to a temp file and compares.)
import { buildSync } from "esbuild";
import * as path from "node:path";
import { fileURLToPath } from "node:url";

const here = path.dirname(fileURLToPath(import.meta.url));
const outfile = process.argv[2] ?? path.join(here, "../analyse-update.js");
