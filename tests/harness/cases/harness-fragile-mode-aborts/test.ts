...
// agent in fragile mode must discover this and emit a FRAGILE-ABORT; `expectFragileAbort` passes
// the meta-test iff that happens (and fails if fragile mode ever stops catching such issues).
